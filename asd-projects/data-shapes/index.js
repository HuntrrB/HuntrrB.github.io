$(document).ready(function () {
  ...
  dataShapes.push(shape); //VERY useful for adding items to a list. This makes it go-
  //to the end of the list. 

  // TODO 2: add a new property to all data shapes
  for (var i = 0; i < dataShapes.length; i++ ) {
   let currentShape = dataShapes[i]; //Okay this actually works and doesn't make the program scream. 
